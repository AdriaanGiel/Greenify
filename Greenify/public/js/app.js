...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__routes_routes__ = __webpack_require__(41);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_layout_NavigationBar__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_material_dist_components__ = __webpack_require__(21);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_views_Home__ = __webpack_require__(42);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_views_Join__ = __webpack_require__(48);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_views_Detail__ = __webpack_require__(96);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_views_Category__ = __webpack_require__(101);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__layout_CompanyButton__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__layout_CompanyButton___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__layout_CompanyButton__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        ...
        CompanyButton: __WEBPACK_IMPORTED_MODULE_0__layout_CompanyButton___default.a
    },
    mounted: function mounted() {
        this.fetchCompany();
    },
    ...
    methods: {
        fetchCompany: function fetchCompany() {
            ...
            this.loading = true;
            axios.get('/api/companies/' + this.$data.category_slug).then(function (response) {
                _this.company = response.data;
                _this.loading = false;
            }).catch(function (error) {
                alert('404 company not found.');
            });
        }
    },
    data: function data() {
    ...
    [
      _c(
        "router-link",
        {
          attrs: {
            to: {
              name: "detail",
              params: {
                category_slug: _vm.category.name,
                company_slug: _vm.company.name
              }
            }
          }
        },
        [
          ...
          _vm._v(" "),
          _c("p", [_vm._v(_vm._s(_vm.company.name.toUpperCase()) + " ")])
        ]
      )
    ],
    1
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("page-wrapper", { attrs: { "bottom-color": "purple" } }, [
    _c(
      "div",
      { attrs: { slot: "content" }, slot: "content" },
      [
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__layout_CategoryCard__ = __webpack_require__(77);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__layout_NavigationBar__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__layout_HamburgerMenu__ = __webpack_require__(15);
...
var render = function() {
  ...
  return _c(
    "router-link",
    {
      ...
      attrs: {
        to: { name: "category", params: { category_slug: _vm.category.name } }
      }
    },
    [
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__HamburgerMenu__ = __webpack_require__(15);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("294016ea", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-dd95e9ac\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/sass-loader/lib/loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Category.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-dd95e9ac\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/sass-loader/lib/loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Category.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.preloader[data-v-dd95e9ac] {\n  height: 100%;\n  width: 100%;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n}\n.preloader .preloader-wrapper[data-v-dd95e9ac] {\n    margin: 0 auto;\n}\n", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        fetchCategory: function fetchCategory() {
            ...
            this.loading = true;
            axios.get("/api/categories/" + this.$data.category_slug).then(function (response) {
...
var render = function() {
  ...
  return _vm.loading
    ...
    : _c("page-wrapper", { attrs: { "bottom-color": _vm.category.color } }, [
        _c("div", { attrs: { slot: "content" }, slot: "content" }, [
          _c("h1", [_vm._v(_vm._s(_vm.category.name.toUpperCase()))])
        ])
      ])
}
var staticRenderFns = [
