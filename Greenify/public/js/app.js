...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__layout_CompanyButton__ = __webpack_require__(67);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        ...
        ButtonDetailCompany: __WEBPACK_IMPORTED_MODULE_1__layout_CompanyButton___default.a
    },
    data: function data() {
        return {
            linkToSite: '#',
...
var render = function() {
  ...
  return _c("div", { staticClass: "button" }, [
    ...
    _vm._v(" "),
    _c("p", [_vm._v("Company " + _vm._s(_vm.company.name.toUpperCase()) + " ")])
  ])
}
var staticRenderFns = []
render._withStripped = true
  ...
  return _c(
    ...
    [
      _vm._t("content", [
        ...
        _vm._v("\n        jervnbkjdncjwsbcks\n\n        "),
        _c("button-detail-company", {
          attrs: { linkDetailCompany: _vm.linkToCompany }
        }),
        _vm._v(" "),
        _c("company-button", {
          attrs: { linkDetailCompany: _vm.linkToCompany }
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("page-wrapper", { attrs: { "bottom-color": _vm.category.color } }, [
    _c("div", { attrs: { slot: "content" }, slot: "content" }, [
